(function(global) {
    ...
    AMREncoder.prototype.init = function() {
        ...
        var ptr = opencoreamr.allocate(1, 'i32', opencoreamr.ALLOC_STACK),
            ret, encSize;
    ...
    AMREncoder.prototype.process = function(pcmdata) {
        ...
        var output_offset = 0,
            offset = 0,
            len, nb, err, tm_str, benchmark = !!this.benchmark,
        ...
        while (offset < pcmdata.length) {
            ...
            /* Encode the frame */
            nb = opencoreamr.Encoder_Interface_Encode(this.state, this.mode, input_addr, buffer_addr, 0);
