...
(function($, window, undefined) {
    ...
    Doc.ready(function() {
        ...
        $(document.body).on('click', '.panel a[data-toggle="remove"]', function(ev) { // Panel Close
            ev.preventDefault();
        ...
        }).on('click', '.panel a[data-toggle="reload"]', function(ev) { // Panel Reload
            ev.preventDefault();
            var $panel = $(this).closest('.panel');
        ...
        }).on('click', '.panel a[data-toggle="panel"]', function(ev) { // Panel Expand/Collapse Toggle
            ev.preventDefault();
            var $panel = $(this).closest('.panel');
